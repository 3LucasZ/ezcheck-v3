...
export default function Home() {
  return (
    <Box p="8">
      ...
      <UnorderedList>
        ...
        <ListItem>
          <Text>
            ...
            this Agreement) refers to EZSuite.
          </Text>
        </ListItem>
        <ListItem>
          <Text>
      ...
      <Heading size="xl">Acknowledgment</Heading>
      <Text>
      ...
      <Heading size="xl">Termination</Heading>
      <Text>
      ...
      <Heading size="xl">Limitation of Liability</Heading>
      <Text>
      ...
      <Heading size="xl">Governing Law</Heading>
      <Text>
      ...
      <Heading size="xl">Disputes Resolution</Heading>
      <Text>
      ...
      <Heading size="xl">For European Union (EU) Users</Heading>
      <Text>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </Text>
      <Heading size="xl">United States Legal Compliance</Heading>
      <Text>
      ...
      <Heading size="xl">Severability and Waiver</Heading>
      ...
      <Heading size="xl">Translation Interpretation</Heading>
      <Text>
      ...
      <Heading size="xl">Changes to These Terms and Conditions</Heading>
      <Text>
